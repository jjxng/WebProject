...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
   ...
   <div class="collapse navbar-collapse" id="#collapsibleNavbar">
      <ul class="nav navbar-nav me-auto">
         ...
         <li class="nav-item"><a class="nav-link active" href="kakaoMap.jsp">오시는길</a></li>
      </ul>
      <%
      // 로그인 하지 않았을 때 보이는 화면
      if(id == null) {
...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=e12cdc606346718f30d179674955b08a"></script>
<script>
var mapContainer = document.getElementById('map'), // 지도를 표시할 div 
  mapOption = { 
        center: new kakao.maps.LatLng(37.552071, 126.918286), // 지도의 중심좌표
        level: 4 // 지도의 확대 레벨
    };
...
var markerImage = new kakao.maps.MarkerImage(imageSrc, imageSize, imageOption),
    markerPosition = new kakao.maps.LatLng(37.552071, 126.918286); // 마커가 표시될 위치입니다
